...
- `wintrust.dll` P/Invoke (`WinVerifyTrust`, `CryptCATAdmin*`) in `TinyWall/ExecutableRiskProbe.cs` for the popup's signature warning; offline, no revocation check, controller process only.
