...
namespace Microsoft.Samples.TaskDialog
{
    ...
    internal class TaskDialog
    {
        ...
        /// </summary>
        internal static bool IsAvailableOnThisOS
        {
            get
            {
        ...
        /// </summary>
        internal static Version RequiredOSVersion
        {
        ...
        /// </summary>
        internal bool EnableHyperlinks
        {
        ...
        /// </summary>
        internal bool AllowDialogCancellation
        {
        ...
        /// </summary>
        internal bool ExpandFooterArea
        {
        ...
        /// is null.
        /// </summary>
        internal bool ExpandedByDefault
        {
        ...
        /// </summary>
        internal bool PositionRelativeToWindow
        {
        ...
        /// </summary>
        internal bool NoDefaultRadioButton
        {
        ...
        /// <returns>The result of the dialog, either a DialogResult value for common push buttons set in the CommonButtons
        /// member or the ButtonID from a TaskDialogButton structure set on the Buttons member.</returns>
        internal int Show(IntPtr hwndOwner, out bool verificationFlagChecked)
        {
        ...
        /// <returns>The result of the dialog, either a DialogResult value for common push buttons set in the CommonButtons
        /// member or the ButtonID from a TaskDialogButton structure set on the Buttons member.</returns>
        internal int Show(IWin32Window owner, out bool verificationFlagChecked, out int radioButtonResult)
        {
        ...
        /// <returns>The result of the dialog, either a DialogResult value for common push buttons set in the CommonButtons
        /// member or the ButtonID from a TaskDialogButton structure set on the Buttons member.</returns>
        internal int Show(IntPtr hwndOwner, out bool verificationFlagChecked, out int radioButtonResult)
        {
            // We have to call a private version or PreSharp gets upset about a unsafe
            // block in a internal method. (PreSharp error 56505)
