...
namespace Microsoft.Samples.TaskDialog
{
    ...
    internal static partial class UnsafeNativeMethods
    {
        ...
        internal struct TASKDIALOGCONFIG
        {
            ...
            /// Flags.
            /// </summary>
            internal TASKDIALOG_FLAGS dwFlags;            // TASKDIALOG_FLAGS (TDF_XXX) flags
            ...
            /// </summary>
            internal uint cxWidth;                                // width of the Task Dialog's client area in DLU's. If 0, Task Dialog will calculate the ideal width.
        }
    }
}
