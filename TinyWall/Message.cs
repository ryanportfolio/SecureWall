    ...
    public class TwMessageConverter : PolymorphicJsonConverter<TwMessage>
    {
        ...
        public override TwMessage? DeserializeDerived(ref Utf8JsonReader reader, int discriminator)
        {
            var ret = (MessageType)discriminator switch
            {
                ...
                MessageType.ALLOW_PROMPT => (TwMessage?)JsonSerializer.Deserialize<TwMessagePromptAction>(ref reader, SourceGenerationContext.Default.TwMessagePromptAction),
        ...
        public override void SerializeDerived(Utf8JsonWriter writer, TwMessage value, JsonSerializerOptions options)
        {
            switch (value)
            {
                ...
                case TwMessageReadPendingPrompts typedVal:
                    JsonSerializer.Serialize<TwMessageReadPendingPrompts>(writer, typedVal, SourceGenerationContext.Default.TwMessageReadPendingPrompts); break;
                case TwMessagePromptAction typedVal:
                    JsonSerializer.Serialize<TwMessagePromptAction>(writer, typedVal, SourceGenerationContext.Default.TwMessagePromptAction); break;
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
    ...
    internal record TwMessagePromptAction : TwMessage
    {
        ...
        public PromptActionStatus Status { get; }
        ...
        internal TwMessagePromptAction CreateResponse(PromptActionStatus status) =>
            new TwMessagePromptAction(Type, Token, status);
    }
