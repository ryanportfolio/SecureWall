...
namespace pylorak.TinyWall
{
    ...
    public sealed class ControllerSettings : ISerializable<ControllerSettings>
    {
        ...
        [DataMember(EmitDefaultValue = false)]
        public bool ConnFormShowConnections = NetworkActivityStatusClassifier.ShowAllowedByDefault;
        [DataMember(EmitDefaultValue = false)]
        public bool ConnFormShowOpenPorts = NetworkActivityStatusClassifier.ShowListeningByDefault;
        [DataMember(EmitDefaultValue = false)]
        public bool ConnFormShowBlocked = NetworkActivityStatusClassifier.ShowBlockedByDefault;
        ...
        internal static string UserDataPath
        {
            get
            {
                ...
                dir = System.IO.Path.Combine(dir, SecureWallProduct.AppDataFolderName);
