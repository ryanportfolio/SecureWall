...
namespace pylorak.TinyWall
{
    internal sealed class TinyWallController : ApplicationContext
    {
        ...
        public TinyWallController(CmdLineArgs opts)
        {
            ...
            PromptPollTimer.Tick += PromptPollTimerTick;
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            {
                ControllerDisposing = true;
                PromptPollTimer.Enabled = false;
                PromptPollTimer.Tick -= PromptPollTimerTick;
        ...
        private async void PromptPollTimerTick(object? sender, EventArgs eventArgs)
        {
            ...
            {
                Utils.LogException(exception, Utils.LOG_ID_GUI);
            }
            finally
            {
                Interlocked.Exchange(ref PromptPollInFlight, 0);
            }
        }
